...
program_name = "Sudoku Hacker v.1"
...
# Define function that clears only values from the puzzle that the solver has generated
# User-entered values will be retained   
def clearsolved():
