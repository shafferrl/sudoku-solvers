...
"sudoku_hacker_raw_algorithm":  Well after having written the previous two/three iteratons of this project, the desire arose to incorporate the sudoku solver into a web page.  The original code was subsequently modified for a more object-oriented approach in additon to being able to "spit out" feedback to the client in the event of a failure to solve the given inputs.  The web-based interface can be accessed at https://perasperadesign.com/extras/sudoku/
